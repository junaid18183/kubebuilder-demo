...
//+kubebuilder:rbac:groups=enbuild.vivsoft.io,resources=catalogs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=enbuild.vivsoft.io,resources=catalogs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=enbuild.vivsoft.io,resources=catalogs/finalizers,verbs=update
